...
export default function Home() {
  return (
     <div>
      ...
      {/* ✅ SEO (ADDED CORRECTLY) */}
      <SEO
        title="HireNest Workforce | IT Staffing & Vendor Network Platform"
        description="HireNest Workforce connects companies, staffing vendors, and IT consultants. Hire top tech talent faster with our vendor network across India."
        path="/"
      />
  ...
  style={{
    background:
      "radial-gradient(circle at 20% 20%, oklch(0.60 0.20 262 / 0.18), transparent 40%), radial-gradient(circle at 80% 30%, oklch(0.55 0.18 200 / 0.15), transparent 40%), linear-gradient(135deg, oklch(var(--navy)) 0%, oklch(0.18 0.05 260) 50%, oklch(0.14 0.06 250) 100%)",
  }}
>
  {/* Glow overlay */}
      ...
      <div className="w-full lg:w-1/2">
        <div className="animate-fade-up max-w-xl">
          ...
          <div
            ...
            style={{
              backgroundColor: "oklch(var(--electric) / 0.12)",
          ...
          {/* Heading */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-white leading-[1.05] mb-6">
            Hire Top Developers & Scale Faster with{" "}
            <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
              HireNest Workforce
            </span>
          </h1>
          <p
  className="mt-3 text-sm font-medium px-3 py-1 inline-block rounded-md"
  style={{
    color: "white",
...
>
  The Collaboration Network for IT Staffing Vendors & Talent
</p>
          ...
          >
            HireNest Workforce is a leading <b>IT staffing company in India</b> and 
            <b> IT recruitment agency</b> helping businesses <b>hire developers in India</b> faster. 
            We provide <b>contract staffing services in India</b> and connect companies with a 
            trusted <b>vendor network for IT staffing</b>.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <Link to="/vendors">
              <button
                className="px-8 py-3 rounded-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
                style={{
                  background:
            ...
            <Link to="/submit-requirement">
              <button
                className="px-8 py-3 rounded-lg font-semibold text-white border border-white/20 backdrop-blur-md hover:bg-white/10 transition"
              >
                Post Requirement
              </button>
            </Link>
          ...
          >
            Trusted by <b>120+ vendors</b> • <b>500+ consultants</b> • 24-hour talent delivery
          </p>
      ...
      {/* RIGHT */}
      <div className="hidden lg:flex items-center justify-center w-full lg:w-1/2 relative scale-125 -translate-x-10">

        {/* Glow behind SVG */}
        <div className="absolute w-[520px] h-[520px] bg-cyan-500/30 blur-3xl rounded-full animate-pulse" />
        <div className="relative z-10 animate-fade-up [animation-delay:0.2s] scale- 110">
  <HeroIllustration />
</div>
